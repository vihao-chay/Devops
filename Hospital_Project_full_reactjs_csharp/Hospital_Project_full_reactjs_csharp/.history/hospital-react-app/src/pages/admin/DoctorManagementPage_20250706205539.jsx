  ...
  const handleSave = async () => {
    try {
      if (isEditing) {
        ...
        await axios.put(`http://localhost:5247/api/Doctor/edit/${doctorToUpdate.id}`, payload);
      } else {
        await axios.post(`http://localhost:5247/api/Doctor`, currentDoctor);
      }
            ...
            <Row>
              ...
              <Col md={6}>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control type="text" name="specialty" value={currentDoctor?.specialization || ''} onChange={handleChange} placeholder="e.g., Cardiology" />
                </Form.Group>
                <Form.Group className="mb-3">
