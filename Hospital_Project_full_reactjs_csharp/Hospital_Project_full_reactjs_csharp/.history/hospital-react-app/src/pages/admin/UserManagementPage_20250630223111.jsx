        ...
        <Modal.Body>
          <Form>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="name" value={currentUser?.name || ''} onChange={handleChange} placeholder="Enter user name" />
            </Form.Group>
            <Form.Group className="mb-3">
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="tel" name="name" value={currentUser?.name || ''} onChange={handleChange} placeholder="Enter phone number" />
            </Form.Group>
             <Form.Group className="mb-3">
