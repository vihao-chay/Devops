        ...
        <Modal.Body>
          <Form>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="username" value={currentUser?.name || ''} onChange={handleChange} placeholder="Enter user name" />
            </Form.Group>
            <Form.Group className="mb-3">
              <Form.Label>Full Name</Form.Label>
              <Form.Control type="text" name="fullname" value={currentUser?.name || ''} onChange={handleChange} placeholder="Enter full name" />
            </Form.Group>
            <Form.Group className="mb-3">
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="tel" name="phonenumber" value={currentUser?.name || ''} onChange={handleChange} placeholder="Enter phone number" />
            </Form.Group>
             <Form.Group className="mb-3">
