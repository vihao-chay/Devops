        ...
        setData([
            {
                ...
                status: 'unpaid',
                items: [
                    { id: 1, name: 'Paracetamol 500mg', quantity: 20, unitPrice: 5000 },
                    { id: 2, name: 'Amoxicillin 500mg', quantity: 20, unitPrice: 15000 },
                    { id: 3, name: 'Omeprazole 20mg', quantity: 10, unitPrice: 20000 },
                    { id: 4, name: 'Vitamin C 500mg', quantity: 30, unitPrice: 3000 }
                ]
            },
            {
                id: 2,
                prescriptionId: 'PRS002',
                patientId: 'PT002',
                ...
                status: 'unpaid',
                items: [
                    { id: 1, name: 'Aspirin 81mg', quantity: 30, unitPrice: 25000 },
                    { id: 2, name: 'Atorvastatin 10mg', quantity: 30, unitPrice: 35000 },
                    { id: 3, name: 'Metoprolol 25mg', quantity: 30, unitPrice: 15000 }
                ]
            },
            {
                id: 3,
                prescriptionId: 'PRS003',
                patientId: 'PT003',
                ...
                status: 'paid',
                items: [
                    { id: 1, name: 'Metformin 500mg', quantity: 60, unitPrice: 12000 },
                    { id: 2, name: 'Gliclazide 30mg', quantity: 30, unitPrice: 18000 }
                ]
            }
        ]);
    }, []);
        ...
        <div style={{ padding: '24px' }}>
            <Card>
                <Title level={2} style={{ marginBottom: '20px' }}>
                    <DollarOutlined /> Quản lý thanh toán đơn thuốc
                </Title>
